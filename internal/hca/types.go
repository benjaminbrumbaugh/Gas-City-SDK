// Package hca provides the provider-neutral Human Coordinator Agent affordance.
//
...
const requestLabel = "gc:hca-request"
...
const (
	...
	// StateRunning records a delivered request awaiting an HCA outcome.
	StateRunning DeliveryState = "running"
	// StateCompleted records a correlated HCA response.
...
// NewService creates a durable HCA request service over the city's bead store.
