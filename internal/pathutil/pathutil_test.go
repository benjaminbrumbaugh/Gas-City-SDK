...
func TestNormalizePathForCompareResolvesSymlinkAncestorForMissingLeaf(t *testing.T) {
	...
	want := NormalizePathForCompare(filepath.Join(realParent, "missing", "gc-home"))
	if got != want {
		t.Fatalf("NormalizePathForCompare() = %q, want %q", got, want)
	}
}

func TestNormalizePathForCompareKeepsCanonicalPrivateVarPath(t *testing.T) {
...
func TestNormalizePathForCompareKeepsCanonicalPrivateTmpPath(t *testing.T) {
