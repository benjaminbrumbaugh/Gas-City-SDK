...
/**
 * Post v0 city by city name extmsg adapters activate
 */
export const postV0CityByCityNameExtmsgAdaptersActivate = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameExtmsgAdaptersActivateData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameExtmsgAdaptersActivateResponses, PostV0CityByCityNameExtmsgAdaptersActivateErrors, ThrowOnError>({
