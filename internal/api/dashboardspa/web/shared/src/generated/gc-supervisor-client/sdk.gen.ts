...
/**
 * Get v0 city by city name external coordination
 */
export const getV0CityByCityNameExternalCoordination = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameExternalCoordinationData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameExternalCoordinationResponses, GetV0CityByCityNameExternalCoordinationErrors, ThrowOnError>({ url: '/v0/city/{cityName}/external-coordination', ...options });

/**
 * Get v0 city by city name external coordination requests
 */
export const getV0CityByCityNameExternalCoordinationRequests = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameExternalCoordinationRequestsData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameExternalCoordinationRequestsResponses, GetV0CityByCityNameExternalCoordinationRequestsErrors, ThrowOnError>({ url: '/v0/city/{cityName}/external-coordination/requests', ...options });

/**
 * Post v0 city by city name external coordination requests
 */
export const postV0CityByCityNameExternalCoordinationRequests = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameExternalCoordinationRequestsData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameExternalCoordinationRequestsResponses, PostV0CityByCityNameExternalCoordinationRequestsErrors, ThrowOnError>({
...
/**
 * Post v0 city by city name external coordination responses
 */
export const postV0CityByCityNameExternalCoordinationResponses = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameExternalCoordinationResponsesData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameExternalCoordinationResponsesResponses, PostV0CityByCityNameExternalCoordinationResponsesErrors, ThrowOnError>({
 ...
 *
 * Results are ordered by decision_id ASC. A truncated response carries next_cursor; passing it back returns the next page in the same order. Invalid or legacy cursors are rejected with the typed 400 invalid-cursor problem.
 */
export const listRoutingDecisions = <ThrowOnError extends boolean = false>(options: Options<ListRoutingDecisionsData, ThrowOnError>) => (options.client ?? client).get<ListRoutingDecisionsResponses, ListRoutingDecisionsErrors, ThrowOnError>({ url: '/v0/city/{cityName}/routing/decisions', ...options });

/**
 * Ingest one signed routing decision
 */
export const ingestRoutingDecision = <ThrowOnError extends boolean = false>(options: Options<IngestRoutingDecisionData, ThrowOnError>) => (options.client ?? client).post<IngestRoutingDecisionResponses, IngestRoutingDecisionErrors, ThrowOnError>({
...
/**
 * Get deterministic eligible-work and target inputs
 *
 * Returns one observation timestamp, work ordered by rig ASC, work_bead_id ASC, and targets ordered by rig ASC, target ASC.
 */
export const getRoutingEligible = <ThrowOnError extends boolean = false>(options: Options<GetRoutingEligibleData, ThrowOnError>) => (options.client ?? client).get<GetRoutingEligibleResponses, GetRoutingEligibleErrors, ThrowOnError>({ url: '/v0/city/{cityName}/routing/eligible', ...options });

/**
 * List authoritative recommendation outcomes
 *
 * Returns a bounded strict-redacted routing/outcome/v2 projection of claimed and terminal decisions in decision_id order. The handler performs no lifecycle or mutation operation.
 */
export const listRoutingOutcomes = <ThrowOnError extends boolean = false>(options: Options<ListRoutingOutcomesData, ThrowOnError>) => (options.client ?? client).get<ListRoutingOutcomesResponses, ListRoutingOutcomesErrors, ThrowOnError>({ url: '/v0/city/{cityName}/routing/outcomes', ...options });

/**
 * Get durable routing-decision status
 */
export const getRoutingStatus = <ThrowOnError extends boolean = false>(options: Options<GetRoutingStatusData, ThrowOnError>) => (options.client ?? client).get<GetRoutingStatusResponses, GetRoutingStatusErrors, ThrowOnError>({ url: '/v0/city/{cityName}/routing/status', ...options });

/**
 * List deterministic static routing targets
 *
 * Returns only selection-safe target identity and labels plus the one-way exact config digest. Results are ordered by rig ASC, target ASC.
 */
export const listRoutingTargets = <ThrowOnError extends boolean = false>(options: Options<ListRoutingTargetsData, ThrowOnError>) => (options.client ?? client).get<ListRoutingTargetsResponses, ListRoutingTargetsErrors, ThrowOnError>({ url: '/v0/city/{cityName}/routing/targets', ...options });
