...
/**
 * Get v0 city by city name hca
 */
export const getV0CityByCityNameHca = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameHcaData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameHcaResponses, GetV0CityByCityNameHcaErrors, ThrowOnError>({ url: '/v0/city/{cityName}/hca', ...options });

/**
 * Get v0 city by city name hca requests
 */
export const getV0CityByCityNameHcaRequests = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameHcaRequestsData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameHcaRequestsResponses, GetV0CityByCityNameHcaRequestsErrors, ThrowOnError>({ url: '/v0/city/{cityName}/hca/requests', ...options });

/**
 * Post v0 city by city name hca requests
 */
export const postV0CityByCityNameHcaRequests = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameHcaRequestsData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameHcaRequestsResponses, PostV0CityByCityNameHcaRequestsErrors, ThrowOnError>({
...
/**
 * Post v0 city by city name hca responses
 */
export const postV0CityByCityNameHcaResponses = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameHcaResponsesData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameHcaResponsesResponses, PostV0CityByCityNameHcaResponsesErrors, ThrowOnError>({
