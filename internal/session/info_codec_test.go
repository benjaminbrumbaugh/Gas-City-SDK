...
func infoFromPersistedBeadFrozen(b beads.Bead) Info {
	...
	info := Info{
		...
		RecoveryIncidentID:       b.Metadata["recovery_incident_id"],
		RecoveryImpairment:       b.Metadata["recovery_impairment"],
		RecoveryDetectedAt:       b.Metadata["recovery_detected_at"],
		RecoveryHoldUntil:        b.Metadata["recovery_hold_until"],
		RecoveryAttempt:          b.Metadata["recovery_attempt"],
		RecoveryAttemptedTargets: b.Metadata["recovery_attempted_targets"],
